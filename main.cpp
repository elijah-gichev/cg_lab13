...
void InitTextures()
{
	LoadTexture(GL_TEXTURE0, texture_t1, "textures/spiderman.dff.png");
	LoadTexture(GL_TEXTURE1, texture_t2, "textures/spiderman.dff.png");
	LoadTexture(GL_TEXTURE2, texture_t3, "textures/spiderman.dff.png");
	LoadTexture(GL_TEXTURE3, texture_t4, "textures/spiderman.dff.png");
	LoadTexture(GL_TEXTURE4, texture_t5, "textures/spiderman.dff.png");
	LoadTexture(GL_TEXTURE5, texture_t6, "textures/spiderman.dff.png");
	LoadTexture(GL_TEXTURE6, texture_t7, "textures/spiderman.dff.png");
}
